...
# Update the config files
	...
	yes | cp -f /etc/named/zones/barfoo.com.conf.master.bak /etc/named/zones/barfoo.com.conf
...
# 	If the service is already running we can use rndc to reload the configs
		...
		echo "The service was started and promoted"
		exit $OCF_SUCCESS
        fi
...
# Retrun the correct return code
	echo "The service was successfully promoted"
	exit $OCF_SUCCESS
